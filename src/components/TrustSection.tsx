  ...
  return (
    <section id="trust" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-14">
          {trustPoints.map((point, i) => {
            ...
            return (
              ...
              >
                <div className="flex-shrink-0 w-11 h-11 rounded-lg bg-green-50 border border-green-200 flex items-center justify-center text-green-700">
        ...
        {/* Metrics bar */}
        <div className="bg-green-800 rounded-xl p-8 grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
          {metrics.map((m) => (
            <div key={m.label} className="text-center">
              <div className="text-3xl font-extrabold text-white">{m.value}</div>
              <div className="text-xs text-green-200 mt-1">{m.label}</div>
            </div>
          ))}
        </div>
